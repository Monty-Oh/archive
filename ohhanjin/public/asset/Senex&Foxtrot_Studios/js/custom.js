$(document).ready(function() {
	...
	function updateWeather() {
		if (lastResponse) {
			...
			$('#weather-text').html(city + ", " + country + " : " + main + ", " + temp + "&deg;C" + (hilow ? " (&darr; " + low + "&deg;C, &uarr; " + high + "&deg;C)" : ""));
		}
	}
